...
<table border="1" class="dataframe">
  <tbody>
    ...
    <p align="justify">
     Desenvolvimento de um exercício computacional para explorar os potenciais de uma linguagem de programação no aprendizado de circuitos elétrico. No caso, a atividade consiste em mostrar o comportamento da saída de um circuito para a variação da resistência de um potenciômetro.   d</p>       
